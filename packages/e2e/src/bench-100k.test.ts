...
test('Benchmark Writer with 100,000 char string', async ({ page }) => {
  ...
  // Generate 100,000 char string
  const text100k = generateRandomString(100000);

  // Type 100,000 char string into the editor
  await editorHandle.type(text100k);
  ...
  // Benchmark it
  bench.add('Generate QrCode Gif from 100,000 char string', async () => {
  ...
  saveBenchMark('bench-100k.json', bench.table());
});
